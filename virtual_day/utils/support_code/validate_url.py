...
from .validate_utils import validator

"""
CODE from lib python 'validators',
link: https://github.com/kvesteri/validators/blob/master/validators/url.py
This code base on 'Django' url validator
...
regex = _lazy_re_compile(  # noqa: W605
    r"^"
    # protocol identifier
    r"(?:(?:https?|ftp)://)"
